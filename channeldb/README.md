...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brsuite/broln/channeldb)
...
```shell
⛰  go get -u github.com/brsuite/broln/channeldb
```
