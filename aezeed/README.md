...
[In this PR](https://github.com/brsuite/broln/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/brsuite/broln/aezeed
...
PASS
ok      github.com/brsuite/broln/aezeed  4.168s
```
