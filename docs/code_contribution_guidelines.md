...
- Changes to publicly exported packages such as
  [brontide](https://github.com/brsuite/broln/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/brsuite/broln/blob/master/lntest/harness.go)
  contained within `broln`. For example integration tests, see
  [`broln_test.go`](https://github.com/brsuite/broln/blob/master/broln_test.go#L181). 
...
[perusing the make file documentation](https://github.com/brsuite/broln/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/brsuite/broln/blob/master/lnrpc/README.md).
...
PR](https://github.com/brsuite/broln/tree/master/docs/release-notes).
...
Rejoice as you will now be listed as a [contributor](https://github.com/brsuite/broln/graphs/contributors)!
...
[MIT license](https://github.com/brsuite/broln/blob/master/LICENSE).  This is
